...
\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{Figures/figure_1_culling}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{Figures/figure_2_culling}
  \caption{State solutions without control, under optimal quadratic control 
  and with linear (bang-bang) control.}
  \label{fig:figure1culling}
\end{figure}
...
\begin{figure}[h]d
  \centering
  \includegraphics[width=\linewidth]{Figures/figure_3_culling}
