...
beginning and reach almost the same level after \SI{5}{year}.

In \Cref{fig:figure2twostraintbm} we show the effect of the parameter 
$\beta_3$. As wee see the simulation suggest that just delay the same profile 
for few months.
%
\begin{figure}
  \centering
  ...
  region to illustrate the variations regarding to case holding.
   Simulation suggest that case holding remains almost with the same profile, 
   while case finding delays same period for only for a few months.
