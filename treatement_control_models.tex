...
must apply over the most of the simulated time, \SI{5}{years}. The total number of 
...
\begin{figure}
  ...
  \caption{
    ...
    region to illustrate the variations regarding to case holding. Simulation suggest 
