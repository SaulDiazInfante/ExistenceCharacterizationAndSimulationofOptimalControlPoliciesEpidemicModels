...
\begin{table}
	...
	\begin{tabular}{rll}
      ...
      \\
		...
		&
<<<<<<< HEAD
		\multicolumn{1}{l}{ $(76/120)N$}
=======
		\multicolumn{1}{r}{ $(76/120)N$}
>>>>>>> fc90b19c59a8b29cb8e92399fce5cb251f321947
		\\
		&\multicolumn{1}{r}{$L_1(0)$}
		& 
		\multicolumn{1}{l}{$(36/120)N$}
		\\
		&\multicolumn{1}{r}{$I_1(0)$} 
		& 
		\multicolumn{1}{l}{$(4/120)N$}
		\\
		&\multicolumn{1}{r}{$L_2(0)$}  
		&\multicolumn{1}{l}{$(2/120) N$}
		\\
		&\multicolumn{1}{r}{$I_2(0)$}
		&\multicolumn{1}{l}{$(1/120)N$}
		\\
		&\multicolumn{1}{r}{$T(0)$}
		& 
		\multicolumn{1}{l}{$(1/120)N$}
