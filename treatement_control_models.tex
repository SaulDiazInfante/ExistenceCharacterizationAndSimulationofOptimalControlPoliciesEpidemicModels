...
\begin{table}
	...
	\begin{tabular}{rll}
        ...
        $\beta_1$ 
            ...
            \\
        $\beta_2$ 
        	& Probability that a recovered individual 
        	\\
        	& become infected by one infectious individual
        	& \num{13.0}
        	\\
        $\beta_3$ 
        	& Probability that a uninfected individual
        	\\
        	& become infected by resistant-TB
            & \num{0.0131}, 
            	\num{0.0217}, 
            	\num{0.029}, 
            	\num{0.0436}
       		\\
     	$\mu$ 
     	    & Natural per-capita natural death rate.
     	    & \num{0.0143}
			\\
     	$d_1$ 
     	    & Per-capita disease death rate by TB.
     	    & \num{0.0}
     	    \\
     	$d_2$ 
		...
		\multicolumn{1}{r}{$S(0)$} 
		&
		\multicolumn{1}{r}{ $(76/120)N$}
		\\
		\multicolumn{1}{r}{$L_1(0)$}
		& 
		\multicolumn{1}{c}{$(36/120)N$}
		\\
		\multicolumn{1}{r}{$I_1(0)$} 
		& 
		\multicolumn{1}{c}{$(4/120)N$}
		\\
		\multicolumn{1}{r}{$L_2(0)$} 
		& 
		\multicolumn{1}{c}{$(2/120) N$}
		\\
		\multicolumn{1}{r}{$I_2(0)$}
		& 
		\multicolumn{1}{c}{$(1/120)N$}
		\\
		\multicolumn{1}{r}{$T(0)$}
		& 
		\multicolumn{1}{c}{$(1/120)N$}
		...
		\bottomrule
    \end{tabular}
	\caption{Parameters description and simulation values for the control problem 
	eq(*)}
\end{table}
