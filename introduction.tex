...
of this question. 
  ...
  The optimal control theory is a way to answer the above question.  In the
...
dynamic programming. Now, these results sustain broad application in the
biological sciences, and, in particular, to the optimal or “efficient” control
